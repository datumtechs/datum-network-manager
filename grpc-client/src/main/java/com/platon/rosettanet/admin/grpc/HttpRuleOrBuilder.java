...
public interface HttpRuleOrBuilder extends
   ...
   * @return The custom.
   */
  com.platon.rosettanet.admin.grpc.CustomHttpPattern getCustom();
  /**
   * <pre>
   * The custom pattern is used for specifying an HTTP method that is not
   * included in the `pattern` field, such as HEAD, or "*" to leave the
   ...
   * <code>.google.api.CustomHttpPattern custom = 8;</code>
   */
  com.platon.rosettanet.admin.grpc.CustomHttpPatternOrBuilder getCustomOrBuilder();
   ...
   * <code>repeated .google.api.HttpRule additional_bindings = 11;</code>
   */
  com.platon.rosettanet.admin.grpc.HttpRule getAdditionalBindings(int index);
  /**
   * <pre>
   * Additional HTTP bindings for the selector. Nested bindings must
   * not contain an `additional_bindings` field themselves (that is,
   ...
   * <code>repeated .google.api.HttpRule additional_bindings = 11;</code>
   */
  com.platon.rosettanet.admin.grpc.HttpRuleOrBuilder getAdditionalBindingsOrBuilder(
      int index);

  public com.platon.rosettanet.admin.grpc.HttpRule.PatternCase getPatternCase();
}
