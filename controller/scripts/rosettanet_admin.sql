drop
database if exists rosettanet_admin;

CREATE
DATABASE rosettanet_admin DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
ALTER TABLE sys_config
    ADD UNIQUE idx_config_key(config_Key);;
...
create
or replace view v_local_stats as
select dataHost.data_host_count,
       powerHost.power_host_count,
...
(
    ...
    from task_power_provider tpp,
         local_org lo,
         task t
    where tpp.identity_id = lo.identity_id
      and tpp.task_id = t.id
