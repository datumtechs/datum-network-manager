...
CREATE TABLE `data_token` (
                              ...
                              `publish_nonce` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT '0' COMMENT '发布凭证交易nonce',
                              `publish_hash` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '发布上链的交易hash，供查询发布状态',
                              `up_nonce` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT '0' COMMENT '上架交易nonce',
...
CREATE TABLE `sys_config` (
                              ...
                              `value` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '配置值',
